document.addEventListener("DOMContentLoaded", () => {
  ...
  const musicData = {
    ...
    effects: [
      { title: "Wii Music - Suspense", file: "media/effects/Wii Music - Gaming Background Music.mp3" },
      ...
      { title: "Uh! Expression Sound", file: "media/effects/Roblox death sound effect.mp3" },
